...
export const VelocityAnimation = () => {
  return (
    <section className="velocity-wrapper relative w-full h-screen  py-[10%] ">
      <ParallaxText baseVelocity={-5}>Framer</ParallaxText>
      <ParallaxText baseVelocity={5}>Scroll</ParallaxText>
    </section>
  );
};
